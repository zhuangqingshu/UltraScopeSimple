...
- `analysis.py` — local measurement over a captured `Waveform` (cursor readings, interpolated sampling). Pure functions, no SCPI, so these features work while disconnected.
